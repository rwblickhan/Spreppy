...
class LeitnerBoxSpacedRepAlgorithmTests: XCTestCase {
    func testIsCorrect() {
        ...
        let newStage = LeitnerBoxSpacedRepAlgorithm.newStage(numIncorrectRepetitions: 10, isCorrect: true, stages: [previousStage, currentStage, nextStage], currentStage: currentStage)
    ...
    func testNoDiff() {
        ...
        let newStage = LeitnerBoxSpacedRepAlgorithm.newStage(numIncorrectRepetitions: 0, isCorrect: false, stages: [previousStage, nextStage, currentStage], currentStage: currentStage)
    ...
    func testOneIncorrect() {
        ...
        let newStage = LeitnerBoxSpacedRepAlgorithm.newStage(numIncorrectRepetitions: 1, isCorrect: false, stages: [previousStage, nextStage, currentStage], currentStage: currentStage)
    ...
    func testMultipleIncorrect() {
        ...
        let newStage = LeitnerBoxSpacedRepAlgorithm.newStage(numIncorrectRepetitions: 4, isCorrect: false, stages: [previousPreviousStage, previousStage, currentStage], currentStage: currentStage)
