...
class SingleCardView: UIView, UIGestureRecognizerDelegate {
    ...
    init() {
        ...
        frontLabel.leadingAnchor.constraint(greaterThanOrEqualToSystemSpacingAfter: leadingAnchor, multiplier: 1).isActive = true
        trailingAnchor.constraint(greaterThanOrEqualToSystemSpacingAfter: frontLabel.trailingAnchor, multiplier: 1).isActive = true
        ...
        backLabel.leadingAnchor.constraint(greaterThanOrEqualToSystemSpacingAfter: leadingAnchor, multiplier: 1).isActive = true
        trailingAnchor.constraint(greaterThanOrEqualToSystemSpacingAfter: backLabel.trailingAnchor, multiplier: 1).isActive = true
        backLabel.topAnchor.constraint(greaterThanOrEqualToSystemSpacingBelow: frontLabel.bottomAnchor, multiplier: 5).isActive = true
